<template>
  <div class="album py-5 bg-light">
    ...
    <div v-else class="container">
      <div class="card mb-3">
        <!-- UserProfileCard -->
        <UserProfileCard :profile="profile" :current-user="currentUser" :is-followed="isFollowed" @after-add-following="afterAddFollowing" @after-delete-following="afterDeleteFollowing" />
      </div>
